 ...
 */
function cf_components_jetpack_setup() {
	// Add theme support for Infinite Scroll.
	add_theme_support(
		'infinite-scroll',
		[
			'container' => 'main',
			'render'    => 'cf_components_infinite_scroll_render',
			'footer'    => 'page',
		]
	);
...
add_action( 'after_setup_theme', 'cf_components_jetpack_setup' );

/**
 * Custom render function for Infinite Scroll.
 */
function cf_components_infinite_scroll_render() {
	while ( have_posts() ) {
		the_post();
		if ( is_search() ) :
 ...
 */
function cf_components_social_menu() {

 ...
 */
add_filter( 'dynamic_sidebar_params', 'cf_widget_classes' );
 ...
 * @return array $params
 */
function cf_widget_classes( $params ) {
...
function cf_widgets_init() {
	register_sidebar(
		[
			'name'          => __( 'Right Sidebar', 'freedomtheme' ),
			'id'            => 'right-sidebar',
			'description'   => __( 'Right sidebar widget area', 'freedomtheme' ),
	...
	register_sidebar(
		[
			'name'          => __( 'Left Sidebar', 'freedomtheme' ),
			'id'            => 'left-sidebar',
			'description'   => __( 'Left sidebar widget area', 'freedomtheme' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
			'before_title'  => '<h3 class="widget-title">',
			'after_title'   => '</h3>',
	...
	register_sidebar(
		[
			'name'          => __( 'Hero Slider', 'freedomtheme' ),
			'id'            => 'hero',
			'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'freedomtheme' ),
	...
	register_sidebar(
		[
			'name'          => __( 'Hero Canvas', 'freedomtheme' ),
			'id'            => 'herocanvas',
			'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'freedomtheme' ),
			'before_widget' => '',
			'after_widget'  => '',
			'before_title'  => '',
			'after_title'   => '',
	...
	register_sidebar(
		[
			'name'          => __( 'Top Full', 'freedomtheme' ),
			'id'            => 'statichero',
			'description'   => __( 'Full top widget with dynamic grid', 'freedomtheme' ),
	...
	register_sidebar(
		[
			'name'          => __( 'Footer Full', 'freedomtheme' ),
			'id'            => 'footerfull',
			'description'   => __( 'Full sized footer widget with dynamic grid', 'freedomtheme' ),
